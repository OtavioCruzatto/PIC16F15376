 ...
 *                 O registrador TMR0 conta até o valor escrito nos registradores (TMR0H | TMR0L) e estoura.
...
void configureTimer0() {
    ...
    T0CON0bits.T016BIT = 1;         // Resolução do Timer0: 16 bits 
    
    TMR0L = 0xFF;                   // Defini valor inicial de contagem: 0
    TMR0H = 0xFF;                   // Defini valor máximo de contagem: 127
